...
public sealed class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> Chinese = new Dictionary<string, string>
    {
        ...
        ["NucleiOptimizerHelp"] = "在代表性的五个 ROI 上筛选参数组合，并把推荐组合填回下方参数；筛选本身不会替代最终分割。",
        ...
        ["AllPositive"] = "全部阳性标记",
        ["AllNegative"] = "全部阴性标记",
        ["AnyPositiveGroups"] = "任一阳性组",
        ["AssignmentParameters"] = "分配参数与最终细胞类型分配",
        ["RunAssignment"] = "运行细胞类型分配",
        ["RunAssignmentOptimizer"] = "运行分配参数优化器",
        ["AssignmentOptimizerHelp"] = "在代表性的五个 ROI 上筛选分配参数，并把推荐值填入当前表单；随后仍需运行最终细胞类型分配。",
        ["GridSize"] = "网格大小",
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["NucleiOptimizerHelp"] = "Screen parameter combinations on five representative ROIs and place the recommendation into the fields below; screening does not replace final segmentation.",
        ...
        ["AnyPositiveGroups"] = "Any-positive groups",
        ...
        ["AssignmentOptimizerHelp"] = "Screen assignment parameters on five representative ROIs and place the recommendation into this form; final cell type assignment still runs afterward.",
        ["GridSize"] = "Grid size",
